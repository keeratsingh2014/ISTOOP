...
class Village(Location):
    def __init__(self, sprite, stage, maxStage, spawn, enemies, chests, npcs, parent):
        super().__init__(sprite, stage, maxStage, spawn, enemies, chests, npcs, parent)
        for i in self.locations:
            self.locations[i]["blocks"] = []
    
def initialise_all():
    dungeon1.initialise()
    dungeon2.initialise()
    dungeon3.initialise()
    bossDungeon1.initialise()
    bossDungeon2.initialise()
    bossDungeon3.initialise()
    village1.initialise()
    village2.initialise()
    village3.initialise()
...
bossDungeon1 = Location("images/region1dungeon1.png", 1, 1, [180, 120], [{"location": (140, 0), "stage": 1, "ref": enemy.boss1, "sprite": enemy.boss1.sprite, "dimensions": (175, 175)}], [], [], world)

bossDungeon2 = Location("images/region3dungeon1.png", 1, 1, [360, 240], [{"location": (140, 0), "stage": 1, "ref": enemy.boss2, "sprite": enemy.boss2.sprite, "dimensions": (175, 175)}], [], [], world)

bossDungeon3 = Location("images/region2dungeon1.png", 1, 1, [0, 240], [{"location": (140, 0), "stage": 1, "ref": enemy.boss3, "sprite": enemy.boss3.sprite, "dimensions": (175, 175)}], [], [], world)


village1 = Village(["images/region1location1.png", "images/region1location2.png", "images/shopper.png"], 1, 2, [180, 180], [], [], [{"location": (280, 140), "stage": 2, "ref": npc.teacher1, "sprite": npc.teacher1.sprite, "dimensions": (140, 140)},
                                                                                                                                    {"location": (140, 140), "stage": 3, "ref": npc.shop1, "sprite": None, "dimensions": (140, 140)}], world)

village2 = Village(["images/region2location1.png", "images/region2location2.png", "images/shopper.png"], 1, 2, [360, 360], [], [], [{"location": (280, 140), "stage": 2, "ref": npc.teacher2, "sprite": npc.teacher2.sprite, "dimensions": (140, 140)},
                                                                                                                                    {"location": (140, 140), "stage": 3, "ref": npc.shop2, "sprite": None, "dimensions": (140, 140)}], world)

village3 = Village(["images/region3location1.png", "images/region3location2.png", "images/shopper.png"], 1, 2, [0, 360], [], [], [{"location": (280, 140), "stage": 2, "ref": npc.teacher3, "sprite": npc.teacher3.sprite, "dimensions": (140, 140)},
                                                                                                                                    {"location": (140, 140), "stage": 3, "ref": npc.shop3, "sprite": None, "dimensions": (140, 140)}], world)