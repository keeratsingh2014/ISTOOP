...
class Game():
    ...
    def update(self):
        ...
        pygame.draw.rect(self.screen, (0, 0, 0), pygame.Rect((player.player_location(self)["x"], player.player_location(self)["y"]), (50, 50)))
